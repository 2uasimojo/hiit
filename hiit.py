...
for _ in range(ex_per_cycle):
    ...
    remaining = [k for k, v in exercises.items() if k not in seen_ex and not v.intersection(last_groups)]
    if len(remaining) == 0:
